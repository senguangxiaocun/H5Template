...
import img from "@/assets/public/dvnishfev_rhweoihaqovba.png";
...
const isAllLoaded = computed(() => listData.value.every((v) => !v.loading));
...
<template>
  <div text-red class="chat-details_box">
    ...
    <chat-list v-model:list="listData" class="bottom-list_box" @send="onSend" />
  </div>
</template>
