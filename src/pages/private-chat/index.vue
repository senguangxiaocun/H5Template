...
import VideoIcon from "@/assets/public/auuwiu_aue8ief.png";
import Head from "@/assets/public/Head.png";
import ImgIcon from "@/assets/public/ifofdbf_awiqioba.png";
import RightMore from "@/assets/public/vddoigfr7hov_qeib23ov.png";
    ...
    >
      <template #left>
        <div flex items-center>
          ...
          <span mt-1 ai-user-name style="color: #fff; font-weight: 600; font-size: small"
            >{{ viewInfo.name }}:</span
          >
        </div>
      </template>
      <template #right>
        <van-image :src="ImgIcon" h-7 w-7 @click="clickElement" />
        <van-image
          mx-6
          :src="VideoIcon"
          h-6
...
.private-chat_box {
  min-height: 100vh;
  background-image: url("@/assets/public/asihdoas_ixcobuvs.png");
